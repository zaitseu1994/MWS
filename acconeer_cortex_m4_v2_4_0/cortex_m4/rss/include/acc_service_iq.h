 ...
 *
 * \deprecated Sampling mode B for the IQ service is deprecated,
 *             sampling mode A will be used in the future
 */
typedef enum
{
 ...
 *
 * \deprecated Function deprecated as sampling mode A will always be used in the future
 *
